...
class _NativeWebViewState extends State<NativeWebView> {
  late NativeWebViewController _controller;
  ...
  Future<void> onPlatformCreated(int? id) async {
    assert(id != null);
    _controller = NativeWebViewController(id: id!, webView: widget);
...
class NativeWebViewController {
  ...
  Future<dynamic> handleMethod(MethodCall call) async {
    switch (call.method) {
      case "onLoadStart":
        if (webView != null && webView!.onLoadStart != null) {
          webView!.onLoadStart!(this);
        }
        break;
      case "onLoadStop":
        if (webView != null && webView!.onLoadStop != null) {
          webView!.onLoadStop!(this);
        }
        break;
      case "onLoadError":
        ...
        if (webView != null && webView!.onLoadError != null) {
          webView!.onLoadError!(this, url, code, message);
        }
        break;
      default:
